...
<div class="card p-3 flex-fill d-flex flex-column" style="min-height: 0">
    ...
    <nav class="navbar navbar-light search-bar">
        <form class="d-flex w-100" method="POST">
            ...
            <input class="form-control me-2" style="flex:1 1 auto; min-width:0;" type="search" placeholder="Rechercher un étudiant" name="search" aria-label="Rechercher un étudiant"">
