...
require_once __DIR__ . "/../ViewOLD/Composants/Modal/filePreviewModal.php";
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-3 align-items-center">
                <?php if($isEducationalManager): ?>
                    <a href="/StudentProfile/<?= $justification->getStudent()->getIdAccount() ?>" class="btn btn-uphf">Profil étudiant</a>
                <?php endif; ?>
            ...
            <?php foreach ($data['absences'] as $absence): ?>
                <div class="d-flex align-items-center border-bottom py-2">
                    ...
                    <div class="me-3">
                        ...
                        <div>Durée: <?= intval($hours) . "h" . $minutes; ?></div>
                    </div>

                    <div class="me-3 h-100">
                        <div>Cour: <?= $absence->getResource()->getLabel() ?></div>
                        <?php if($absence->getTeacher() !== null): ?>
                            <div>Enseignant : <?= $absence->getTeacher()->getFirstName() . " " . $absence->getTeacher()->getLastName() ?></div>
                        <?php else: ?>
                            <div>&nbsp;</div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="col-md-6 d-flex flex-column h-100" style="min-height: 0">
            ...
            <div class="border rounded overflow-y-auto flex-fill" style="min-height:0">
                ...
                <?php foreach ($data['files'] as $file): ?>
                    ...
                    $viewUrl = "/file.php?idFile=" . $file->getIdFile();
                    ?>
                        ...
                        <?php foreach ($data['comments'] as $comment): ?>
                            <li>
                                <a class="dropdown-item predefined-comment" href="#"
                                   data-value="<?= htmlspecialchars($comment->getTextComment()) ?>">
                                    <?= htmlspecialchars($comment->getTextComment()) ?>
                                </a>
                            </li>
                        <?php endforeach; ?>
