...
<div class="accordion-item border-bottom">
    ...
    <div class="accordion-header">
        ...
        >
            <div class="d-flex flex-column">
                ...
                <?php [$hours, $minutes] = explode(":", $abs->getDuration()); ?>
            ...
            <div class="d-flex align-items-center gap-3 flex-grow-1">
                ...
                if(!$abs->getAllowedJustification() && $abs->getCurrentState() === StateAbs::Refused) {
    ...
    <div id="flush-collapse-abs-<?= $index ?>" class="accordion-collapse collapse" data-bs-parent="#absFlush">
        <div class="accordion-body p-3">
            ...
            <p><strong>Matière :</strong> <?= htmlspecialchars($abs->getCourseType()->value . " " . $abs->getResource()->getLabel()) ?></p>
