<div class="d-flex flex-column flex-grow-1 min-vh-100">
    ...
    <div class="d-flex justify-content-center mx-auto mt-5 mb-4 my-md-auto overflow-hidden" style="max-width:900px;">
        ...
        <div class="rounded-end-1 card-uphf d-none d-md-flex align-items-start justify-content-start" style="width: 30%; min-width:220px;">
    </div>
</div><?php
