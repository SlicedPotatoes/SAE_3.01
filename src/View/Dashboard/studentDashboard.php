...
require "./View/Headers/studentDashboardHeader.php";
 ...
 */
    ...
    require_once "./Presentation/AbsencePresentation.php";
    require_once "./Presentation/JustificationPresentation.php";
