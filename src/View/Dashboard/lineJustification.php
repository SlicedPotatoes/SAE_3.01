<div class="accordion-item">
    <div class="accordion-header">
        <button class="accordion-button collapsed d-flex align-items-center gap-3 p-3"
                ...
                data-bs-target="#flush-collapse-justification-<?= $justification->getId(); ?>"
                aria-expanded="false" aria-controls="flush-collapse-justification-<?= $justification->getId(); ?>"
        >
    ...
    <div id="flush-collapse-justification-<?= $justification->getId(); ?>" class="accordion-collapse collapse" data-bs-parent="#justificationFlush">
