...
$absenceTotal = $data['studentAbsInfos']['absTotal'];
$halfdayTotal = $data['studentAbsInfos']['halfdaysAbsences'];
$absenceAllowJustification = $data['studentAbsInfos']['absCanBeJustified'];

$malus = $data['studentAbsInfos']['malusPoints'];
$malusWithoutPending = $data['studentAbsInfos']['malusPointsWithoutPending'];
$penalizingAbsence = $data['studentAbsInfos']['penalizingAbsence'];
$halfdayPenalizingAbsence = $data['studentAbsInfos']['halfdayPenalizingAbsence'];
?>

<!-- Card du dashboard avec informations sur l'assiduité -->
<div class="row row-cols-2 row-cols-md-4 g-2 px-2 px-md-0">
