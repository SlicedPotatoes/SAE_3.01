<?php
require_once __DIR__ . "/../src/Model/Absence.php";
...
$tests = [
    ...
    "Test 5 : endDate only" => [null, null, '2025-09-05', false, false, null],
    "Test 6 : startDate only" => [null, '2025-09-04', null, false, false, null],
    "Test 7 : same Date" => [null, '2025-09-01', '2025-09-01', false, false, null],
    "Test 8 : Normal Date" => [null, '2025-09-05', '2025-09-06', false, false, null],
