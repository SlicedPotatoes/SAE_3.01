...
class FeatureContext3 extends BehatContext
{
    /**
    ...
    /**
     * @When /^je met en date de départ "2026\-05\-01"([^"]*)"2026\-05\-30"$/
     */
    public function jeMetEnDateDeDépartEtEnDateDeFin($arg1, $arg2)
    {
        throw new PendingException();
     ...
     * @Given /^je suis connecté à un compte étudiant de numéro étudiant (.*) sur la page de dépot de justificatif$/
     */
    public function jeSuisConnectéÀUnCompteÉtudiantDeNuméroÉtudiantSurLaPageDeDépotDeJustificatif($etu)
    {
        throw new PendingException();
    }
     ...
     * @Given /^j ai une absence le (.*) à (.*) d une durée de (.*) et (.*) examen$/
     */
    public function jAiUneAbsenceLeÀDUneDuréeDeEtExamen($date, $heure, $duree, $exam)
    {
        throw new PendingException();
    }
     ...
     */
    public function jeMetEnDateDeDépartEtEnDateDeFin($debut, $fin)
    {
        throw new PendingException();
    }
     ...
     * @Given /^j ai entré un commentaire qui dit (.*)$/
     */
    public function jAiEntréUnCommentaireQuiDit($com)
    {
        throw new PendingException();
    }
     ...
     * @Then /^le nombre de justificatif doit être égale à (.*)$/
     */
    public function leNombreDeJustificatifDoitÊtreÉgaleÀ($nbJusti)
    {
        throw new PendingException();
    }
     ...
     * @Given /^l absence du (.*) à (.*) d une durée de (.*) et (.*) examen doit être en (.*)$/
     */
    public function lAbsenceDuÀDUneDuréeDeEtExamenDoitÊtreEn($date, $heure, $duree, $exam, $etat)
    {
        throw new PendingException();
    }
}